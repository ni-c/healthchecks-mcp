...
const site = 'https://healthchecks-mcp.ni-c.de';
const description = 'MCP server for Healthchecks — inspect, create and adjust cron and uptime checks, and read why one failed';
...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:site_name', content: 'healthchecks-mcp' }],
    ['meta', { property: 'og:title', content: 'healthchecks-mcp' }],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Reference', link: '/reference/tools', activeMatch: '/reference/' },
      {
        ...
        items: [
          ...
          { text: 'Releases', link: 'https://github.com/ni-c/healthchecks-mcp/releases' },
          { text: 'npm package', link: 'https://www.npmjs.com/package/healthchecks-mcp' },
        ],
      },
    ],
      ...
      '/guide/': [
        {
          text: 'Introduction',
          items: [
            { text: 'What is healthchecks-mcp?', link: '/guide/' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/ni-c/healthchecks-mcp' },
      {
        icon: {
    ...
    editLink: {
      pattern: 'https://github.com/ni-c/healthchecks-mcp/edit/main/docs/:path',
